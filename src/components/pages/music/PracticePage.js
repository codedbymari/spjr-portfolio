...
const PracticePage = ({ currentPage, onNavigate, isLoadingComplete }) => {
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <section className="px-0 py-7">
            <div className="grid items-start gap-6 grid-cols-1 md:grid-cols-2 h-full">
              ...
              >
                <img
                  src="./assets/images/practice-p.webp"
                ...
                <section className="flex flex-col justify-between h-full">
                  ...
                  <div className="flex-1 flex items-center py-8">
                    <p 
                      ...
                      style={{ color: isDark ? '#FFFFFF' : '#000000' }}
                    >
What's heartbreak, like I don't know that pain,<br/>
There's never love lost, only love gained.<br/>
Through the nights and the lows, the aims to maintain,<br/>
A blank canvas will get stained with this pain.<br/>
When I'm high off purple, I turn my pain into passion,<br/>
Practice makes perfect, turning problems into practice.<br/>                    </p>
                  </div>
