...
const GreatExpectationPage = ({ currentPage, onNavigate, isLoadingComplete }) => {
                ...
                <section className="flex flex-col justify-between h-full">
                  ...
                  <div className="flex-1 flex items-center py-8">
                    <p 
                      ...
                      style={{ color: isDark ? '#FFFFFF' : '#000000' }}
                    >
                    "Even if I die a pauper I won't die with envy,<br/>
                      King Solomon, nothing but knowledge and wealth is plenty.<br/>
                      How we living in the future but still tied to the past,<br/>
                      Battling tendencies for failure but I'm ahead of my class.<br/>
                      Even if I heard every song on the earth,<br/>
                      I'd only dance to the whisper in my soul..."<br/>
                    </p>
                  </div>
                    ...
                    >
                      ...
                      >
                        <div className="pt-2">
                          <audio
                            ref={audioRef}
                            src="./assets/audio/GreatExpectations.mp3"
                            preload="metadata"
                          />
...
export default GreatExpectationPage;