...
const SonOfAFarmerPage = ({ currentPage, onNavigate, isLoadingComplete }) => {
                ...
                <section className="flex flex-col justify-between h-full">
                  ...
                  <div className="flex-1 flex items-center py-8">
                    <p 
                      ...
                      style={{ color: isDark ? '#FFFFFF' : '#000000' }}
                    >
"You showed me how to lead before I became a leader,<br/>
And you're the one that taught me before I became the teacher.<br/>
Thankful for your footsteps, though you never bought me sneakers.<br/>
But you taught me; fuck feelings, boy, listen to your own reason..."<br/>                  </p>
                  </div>
                    ...
                    >
                      ...
                      >
                        <div className="pt-2">
                          <audio
                            ref={audioRef}
                            src="./assets/audio/SonofaFarmer.mp3"
                            preload="metadata"
                          />
...
export default SonOfAFarmerPage;