...
const CrossroadsToHomePage = ({ currentPage, onNavigate, isLoadingComplete }) => {
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <section className="px-0 py-7">
            <div className="grid items-start gap-6 grid-cols-1 md:grid-cols-2 h-full">
              ...
              >
                <img
                  src="./assets/images/crossroads.webp"
                  alt="Crossroads to Home album cover"
                ...
                <section className="flex flex-col justify-between h-full">
                  ...
                  <div className="flex-1 flex items-center py-8">
                    <p 
                      ...
                      style={{ color: isDark ? '#FFFFFF' : '#000000' }}
                    >
                      "Started off as a pawn, graduated to captain,<br/>
                      Depth over distance, lungs kept on adapting.<br/>
                      Got lost in the darkness with a candle and matchstick,<br/>
                      Burn a forest to a crisp when my spirit feels trapped in."
                    </p>
                  </div>
                    ...
                    >
                      ...
                      >
                        <div className="pt-2">
                          <audio
                            ref={audioRef}
                            src="./assets/audio/CROSSROADTOHOME.mp3"
                            preload="metadata"
                          />
...
export default CrossroadsToHomePage;