  ...
  return (
    <div className="w-screen min-h-screen bg-[#000000] overflow-x-hidden relative">
      ...
      <main className="pt-[80px] sm:pt-[90px] md:pt-[100px]">
        ...
        {/* Hero Section */}
        <section className="flex flex-col items-center justify-center min-h-[60vh] bg-[#000000] py-12 sm:py-16 md:py-20 px-4 sm:px-5 md:px-8 lg:px-5 relative z-10">
          <div className="flex flex-col items-center w-full max-w-[1200px] pb-8 sm:pb-10 md:pb-12">
            ...
            <motion.div
              ...
              className="text-[#FFFFFf] font-normal tracking-[-0.03em] leading-[100%] text-center mb-8 sm:mb-10 md:mb-12"
              style={{
            ...
            <motion.div
              ...
              className="text-[#FFFFFF] text-center max-w-[600px] text-[16px] sm:text-[18px] md:text-[20px] font-light leading-[1.5]"
        ...
        <section className="flex flex-col items-center justify-center bg-[#000000] py-12 sm:py-16 md:py-20 px-4 sm:px-5 md:px-8 lg:px-5 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row gap-12 sm:gap-16 md:gap-20 w-full max-w-[1200px]">
            ...
            <div className="flex-1 space-y-6 sm:space-y-8 md:space-y-10">
              ...
              >
                <h2 className="text-[#FFFFFF] text-[24px] sm:text-[28px] md:text-[32px] font-normal mb-4 sm:mb-5 md:mb-6" 
                    style={{ fontFamily: 'Switzer, sans-serif' }}>
                  What is Pen2Purpose?
                </h2>
                <p className="text-[#FFFFFF] text-[14px] sm:text-[15px] md:text-[16px] font-normal leading-[1.6]">
              ...
              >
                <h3 className="text-[#FFFFFF] text-[20px] sm:text-[22px] md:text-[24px] font-normal mb-4 sm:mb-5 md:mb-6" 
                    style={{ fontFamily: 'Switzer, sans-serif' }}>
                  Meeting Details
                </h3>
                <div className="space-y-2 sm:space-y-3 text-[#FFFFFF] text-[14px] sm:text-[15px] md:text-[16px] font-normal leading-[1.6]">
            ...
            <div className="flex-1 lg:max-w-[400px]">
              <motion.div
                className="bg-[#111111] p-8 sm:p-10 md:p-12 rounded-lg"
                initial={getInitialState({ opacity: 0, y: 50 })}
                animate={getAnimateState({ opacity: 1, y: 0 })}
                transition={{ 
                  duration: 1.5, 
              ...
              >
                <h3 className="text-[#FFFFFF] text-[24px] sm:text-[26px] md:text-[28px] font-normal mb-6 sm:mb-7 md:mb-8" 
                    style={{ fontFamily: 'Switzer, sans-serif' }}>
                  Join Our Community
                </h3>
                ...
                {!isSubmitted ? (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <input
                        ...
                        className="w-full px-0 py-4 bg-transparent border-0 border-b border-[#333333] text-[#FFFFFF] text-[14px] sm:text-[15px] md:text-[16px] placeholder-[#666666] focus:outline-none focus:border-[#FFFFFF] transition-colors duration-300"
                        onKeyPress={(e) => e.key === 'Enter' && handleSubmit(e)}
                      />
                      <motion.button
                        onClick={handleSubmit}
                        className="w-full bg-[#FFFFFF] text-[#000000] py-4 px-8 text-[11px] sm:text-[12px] md:text-[13px] font-normal tracking-[-0.01em] uppercase font-mono hover:bg-[#CCCCCC] transition-colors cursor-pointer rounded-sm"
                  ...
                  >
                    <div className="text-[#FFFFFF] text-[16px] sm:text-[17px] md:text-[18px] font-normal leading-[1.5] mb-4">
                      🎉 Welcome to Pen2Purpose!
                    </div>
                    <p className="text-[#CCCCCC] text-[14px] sm:text-[15px] md:text-[16px] font-normal leading-[1.5]">
        ...
        <section className="flex flex-col items-center justify-center bg-[#000000] py-16 sm:py-20 md:py-24 px-4 sm:px-5 md:px-8 lg:px-5 relative z-10">
          <motion.blockquote
