...
const MphepoPage = ({ 
  ...
  const reflectionParagraphs = [
    'Before God said "Let there be life," his omniscient mind decided to create breath. Scriptures say, "Let there be light." But what ignites the light in my heart, if not the breath of life? So, God must first have held air in his palms and placed wind into my lazy lungs.',
